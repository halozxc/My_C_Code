...
int main()
{
    ...
    printf("straightInsert 对随机数排序后 compareNUM:%lld moveNum:%lld,时间：%lf\n",compareNum,moveNum,(double)(nEndTime.QuadPart-m_begintime.QuadPart)*1000/m_nFreq.QuadPart);
    moveNum = 0,compareNum=0;
    QueryPerformanceCounter(&m_begintime);
    straightInsert(tempArray, NUM,'>');
     QueryPerformanceCounter(&nEndTime);
    printf("straightInsert 对逆序数排序后 compareNUM:%lld moveNum:%lld,时间：%lf\n",compareNum,moveNum,(double)(nEndTime.QuadPart-m_begintime.QuadPart)*1000/m_nFreq.QuadPart);
    moveNum = 0,compareNum=0;
    QueryPerformanceCounter(&m_begintime);
    straightInsert(tempArray, NUM,'>');
     QueryPerformanceCounter(&nEndTime);
    printf("straightInsert 对顺序数排序后 compareNUM:%lld moveNum:%lld,时间：%lf\n",compareNum,moveNum,(double)(nEndTime.QuadPart-m_begintime.QuadPart)*1000/m_nFreq.QuadPart);
    moveNum = 0,compareNum=0;
    newArray();
     QueryPerformanceCounter(&m_begintime);
    popSort(tempArray, NUM,'<');
     QueryPerformanceCounter(&nEndTime);
    printf("popSort 对随机数排序后 compareNUM:%lld moveNum:%lld,时间：%lf\n",compareNum,moveNum,(double)(nEndTime.QuadPart-m_begintime.QuadPart)*1000/m_nFreq.QuadPart);
    moveNum = 0,compareNum=0;
    QueryPerformanceCounter(&m_begintime);
    popSort(tempArray, NUM,'>');
     QueryPerformanceCounter(&nEndTime);
    printf("popSort 对逆序数排序后 compareNUM:%lld moveNum:%lld,时间：%lf\n",compareNum,moveNum,(double)(nEndTime.QuadPart-m_begintime.QuadPart)*1000/m_nFreq.QuadPart);
     moveNum = 0,compareNum=0;
    QueryPerformanceCounter(&m_begintime);
    popSort(tempArray, NUM,'>');
     QueryPerformanceCounter(&nEndTime);
    printf("popSort 对顺序数排序后 compareNUM:%lld moveNum:%lld,时间：%lf\n",compareNum,moveNum,(double)(nEndTime.QuadPart-m_begintime.QuadPart)*1000/m_nFreq.QuadPart);
    moveNum = 0,compareNum=0;
    newArray();
     QueryPerformanceCounter(&m_begintime);
    quick_sort(tempArray, 0, sizeodarray,'<');
     QueryPerformanceCounter(&nEndTime);
    printf("quick_sort 对随机数排序后 compareNUM:%lld moveNum:%lld,时间：%lf\n",compareNum,moveNum,(double)(nEndTime.QuadPart-m_begintime.QuadPart)*1000/m_nFreq.QuadPart);
    moveNum = 0,compareNum=0;
    quick_sort(tempArray, 0, sizeodarray,'>');
     QueryPerformanceCounter(&nEndTime);
    printf("quick_sort 对逆序数排序后 compareNUM:%lld moveNum:%lld,时间：%lf\n",compareNum,moveNum,(double)(nEndTime.QuadPart-m_begintime.QuadPart)*1000/m_nFreq.QuadPart);
     moveNum = 0,compareNum=0;
     QueryPerformanceCounter(&m_begintime);
    quick_sort(tempArray, 0, sizeodarray,'>');
     QueryPerformanceCounter(&nEndTime);
    printf("quick_sort 对顺序数排序后 compareNUM:%lld moveNum:%lld,时间：%lf\n",compareNum,moveNum,(double)(nEndTime.QuadPart-m_begintime.QuadPart)*1000/m_nFreq.QuadPart);
    moveNum = 0,compareNum=0;
    newArray();
    QueryPerformanceCounter(&m_begintime);
    MergeSort(tempArray, 0, sizeodarray,'<');
     QueryPerformanceCounter(&nEndTime);
    printf("MergeSort 对随机数排序后 compareNUM:%lld moveNum:%lld,时间：%lf\n",compareNum,moveNum,(double)(nEndTime.QuadPart-m_begintime.QuadPart)*1000/m_nFreq.QuadPart);
    moveNum = 0,compareNum=0;
    QueryPerformanceCounter(&m_begintime);
    MergeSort(tempArray, 0, sizeodarray,'>');
     QueryPerformanceCounter(&nEndTime);
    printf("MergeSort 对逆序数排序后 compareNUM:%lld moveNum:%lld\n,时间：%lf",compareNum,moveNum,(double)(nEndTime.QuadPart-m_begintime.QuadPart)*1000/m_nFreq.QuadPart);
    moveNum = 0,compareNum=0;
     QueryPerformanceCounter(&m_begintime);
    MergeSort(tempArray, 0, sizeodarray,'>');
     QueryPerformanceCounter(&nEndTime);
